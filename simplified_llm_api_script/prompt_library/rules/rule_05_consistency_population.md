---
scope: 'relevant_sections: Population, Redlist Assessment'
severity: 'high'
...
must be recorded. These may be recorded in the separate data fields in SIS,
...
within the text, ensure that all of the following information is included:
	1. Rate of population reduction over the past ten years or three generations (note that for criteria A and C1, generation length must also be recorded – section 2.3.2).
	2. Qualifier for the stated reduction (i.e., observed, estimated, inferred or suspected reduction)
	3. Information supporting the use of direct observation and decline in AOO, EOO and/or quality of habitat as the basis for the reduction.
	4. Estimated current population size, with an indication of how this was estimated.
	5. Justification for continuing decline in population size, and the qualifier for this (i.e., is continuing decline observed, estimated, projected, or inferred?)
	6. Estimated size of the largest subpopulation.
	
### Population where specific data and qualifiers are recorded in separate data fields in SIS
#### Preferred Style
...
### Population where specific data and parameters are included only in the narrative text
#### Preferred Style
Until 2002, this frog was very common within
its small range; often it was found at numerous
localities. Between 2002 and 2011 the same sites
